  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Image.asset('assets/images/fruits/banana.jpg'),
                    ...
                    setState(() {
                      ...
                      if (_isFavorite) {
                        ...
                        if (!widget.favoriteItems
                            .any((item) => item['name'] == "Banana")) {
                          widget.favoriteItems.add({
                            'name': "Banana",
                            'imagePath': 'assets/images/fruits/banana.jpg',
                            'description': 'Yellow, sweet bananas',
                            'price': 50.0,
                          });
                        }
                      } else {
                        widget.favoriteItems
                            .removeWhere((item) => item['name'] == "Banana");
                      }
                    });
                  },
                  icon: Icon(
            ...
            ExpansionTile(
              ...
              children: const [
                ListTile(
                    title: Text(
                        "These are fresh, yellow bananas. They are sweet and delicious.")
                ),
              ],
            ),
            ExpansionTile(
              ...
              children: const [
                ListTile(
                    title: Text(
                        "Bananas are a good source of fiber and vitamin B6. They are also low in calories and fat.")
                ),
              ],
            ),
            ExpansionTile(
              ...
              children: const [
                ListTile(
                    title: Text(
                        "Bananas are delicious! They are sweet and creamy, and they make a great snack or breakfast.")
                ),
              ],
            ),
          ],
