  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Image.asset('assets/images/fruits/mangoes.jpg'),
                    ...
                    setState(() {
                      ...
                      if (_isFavorite) {
                        ...
                        if (!widget.favoriteItems
                            .any((item) => item['name'] == "Mangoes")) {
                          widget.favoriteItems.add({
                            'name': "Mangoes",
                            'imagePath': 'assets/images/fruits/mangoes.jpg',
                        ...
                        widget.favoriteItems
                            .removeWhere((item) => item['name'] == "Mangoes");
                      }
                    });
                  },
                  icon: Icon(
            ...
            ExpansionTile(
              ...
              children: const [
                ListTile(
                    title: Text(
                        "These are fresh, juicy mangoes. They are perfect for a healthy snack or dessert.")
                ),
              ],
            ),
            ExpansionTile(
              ...
              children: const [
                ListTile(
                    title: Text(
                        "Mangoes are a good source of fiber and vitamins A and C. They are also low in calories and fat.")
                ),
              ],
            ),
            ExpansionTile(
              ...
              children: const [
                ListTile(
                    title: Text(
                        "These mangoes are absolutely delicious! They are sweet, juicy, and have a wonderful tropical flavor. I highly recommend them.")
                ),
              ],
            ),
          ],
