  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Image.asset('assets/images/fruits/orange.jpg'),
                    ...
                    setState(() {
                      ...
                      if (_isFavorite) {
                        ...
                        widget.favoriteItems
                            .removeWhere((item) => item['name'] == "Orange");
                      }
                    });
                  },
                  icon: Icon(
            ...
            ExpansionTile(
              ...
              children: const [
                ListTile(
                    title: Text(
                        "These are fresh, juicy oranges. They are perfect for a healthy snack or breakfast.")
                ),
              ],
            ),
            ExpansionTile(
              ...
              children: const [
                ListTile(
                    title: Text(
                        "Oranges are a good source of fiber and vitamin C. They are also low in calories and fat.")
                ),
              ],
            ),
            ExpansionTile(
              ...
              children: const [
                ListTile(
                    title: Text(
                        "These oranges are delicious! They are sweet and juicy, and they make a great snack or breakfast.")
                ),
              ],
            ),
          ],
